...
// console.log(verdict);
// Output: The weapon is the Revolver. Reason: changeWeapon is called, changing the scenario's weapon property to 'Revolver'. delclareWeapon is then called, returning a string that refers to the scenario's weapon property.
//
...
// const verdict = declareMurderer();
// console.log(verdict);
// Output: The murderer is Mrs. White. Reason: changeMurder is called, which first reassigns murderer to have the value 'Mr. Green', then calls a second function, plotTwist, which reassigns murderer to have the value 'Mrs. White'. declareMurderer is then called returning a string that refers to murderer.
//
// Episode 7
//
// let murderer = 'Professor Plum';

...
// ```
// let is limited to function scope. This code will return three suspects (Miss Scarlet, Prof Plum, Mrs Peacock) as the return is within the {} and it calls three suspects. There is also an additional call for suspect 3 using interpolation
...
// console.log(verdict);
// ```
// This returns the declared murder weapon which had been changed from candle-stick to revolver. This occurs as a cosnt changeWeapon allows the weapon to be changed and below that it is carried out and called.
...
// On first glance I expected this to return Miss Scarlet, but it returns Mr Green. I think this is because it calls changeMurderer in line 166.
